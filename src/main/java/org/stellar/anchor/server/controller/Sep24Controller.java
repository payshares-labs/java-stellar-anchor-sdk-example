...
public class Sep24Controller {
    ...
    public InteractiveTransactionResponse deposit(HttpServletRequest request,
                                                  @RequestBody HashMap<String, String> requestData) throws SepException, MalformedURLException, URISyntaxException {
    ...
    public InteractiveTransactionResponse depositAllType(HttpServletRequest request) throws SepException, MalformedURLException, URISyntaxException {
    ...
    @RequestMapping(
            ...
            consumes = {MediaType.APPLICATION_JSON_VALUE},
            method = {RequestMethod.POST})
    public InteractiveTransactionResponse withdraw(HttpServletRequest request,
                                                   @RequestBody HashMap<String, String> requestData) throws SepException, MalformedURLException, URISyntaxException {
    ...
    @RequestMapping(
            ...
            method = {RequestMethod.POST},
            consumes = {MediaType.MULTIPART_FORM_DATA_VALUE})
    public InteractiveTransactionResponse withdrawAllType(HttpServletRequest request) throws SepException, MalformedURLException, URISyntaxException {
        HashMap<String, String> requestData = new HashMap<>();
        for (Map.Entry<String, String[]> entry : request.getParameterMap().entrySet()) {
            requestData.put(entry.getKey(), entry.getValue()[0]);
        }
    ...
    public GetTransactionsResponse getTransactions(HttpServletRequest request, @RequestBody GetTransactionsRequest tr) throws SepException, MalformedURLException, URISyntaxException {
    ...
    @RequestMapping(
            ...
            method = {RequestMethod.GET})
    public GetTransactionsResponse getTransactions(HttpServletRequest request,
        ...
        debugF("/transactions asset_code={} kind={} limit={} no_older_than={} paging_id={}", assetCode, kind, limit, noOlderThan, pagingId);
        GetTransactionsRequest gtr = GetTransactionsRequest.of(assetCode, kind, limit, noOlderThan, pagingId);
    ...
    @RequestMapping(
            ...
            consumes = {MediaType.APPLICATION_JSON_VALUE},
            method = {RequestMethod.GET})
    public GetTransactionResponse getTransaction(HttpServletRequest request,
                                                 @RequestBody GetTransactionRequest tr) throws SepException, IOException, URISyntaxException {
    ...
    public GetTransactionResponse getTransaction(HttpServletRequest request,
                                                 ...
                                                 @RequestParam(required = false, value = "external_transaction_id") String externalTransactionId,
                                                 @RequestParam(required = false, value = "stellar_transaction_id") String stellarTransactionId) throws SepException, IOException, URISyntaxException {
        debugF("/transaction id={} external_transaction_id={} stellar_transaction_id={}", id, externalTransactionId, stellarTransactionId);
        GetTransactionRequest tr = new GetTransactionRequest(id, stellarTransactionId, externalTransactionId);
    ...
    JwtToken getSep10Token(HttpServletRequest request) throws SepValidationException {
        ...
        if (token == null) {
            throw new SepValidationException("missing sep10 jwt token. Make sure the sep10 filter is invoked before the controller");
        }
        return token;
    }
