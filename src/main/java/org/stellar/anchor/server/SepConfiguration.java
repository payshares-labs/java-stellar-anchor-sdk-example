...
public class SepConfiguration {
     ...
     */
    @Bean
    public FilterRegistrationBean<Sep10TokenFilter> sep10TokenFilter(@Autowired Sep10Config sep10Config, @Autowired JwtService jwtService) {
    ...
    @Bean
    AssetService assetService(AppConfig appConfig) throws IOException {
    ...
    @Bean
    Sep10Service sep10Service(AppConfig appConfig,
    ...
    @Bean
    Sep24Service sep24Service(AppConfig appConfig,
