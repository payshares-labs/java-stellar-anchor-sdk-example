...
public class JdbcSep24TransactionStore implements Sep24TransactionStore {
    ...
    @Override
    public List<Sep24Transaction> findTransactions(String accountId, GetTransactionsRequest tr) throws SepValidationException {
        List<Sep24Transaction> txns = txnRepo.findByStellarAccountAndAssetCodeOrderByStartedAtDesc(accountId, tr.getAssetCode());
        ...
        if (tr.getNoOlderThan() == null) {
            ...
            try {
                ...
                throw new SepValidationException(String.format("invalid no_older_than field: %s", tr.getNoOlderThan()));
            }
        }
    ...
    public Sep24Transaction save(Sep24Transaction sep24Transaction) throws SepException {
        if (!(sep24Transaction instanceof JdbcSep24Transaction)) {
            throw new SepException(sep24Transaction.getClass() + "  is not a sub-type of " + JdbcSep24Transaction.class);
        }
